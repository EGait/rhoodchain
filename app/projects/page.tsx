    ...
    <main className="bg-[#08100c] min-h-screen text-gray-100">
      ...
      <div className="px-6 md:px-8 py-12 border-b text-center" style={{ borderColor: 'rgba(34,197,94,0.2)' }}>
        ...
        <h1 className="text-3xl md:text-4xl font-medium mb-3">
          Top{' '}
          <span style={{ color: '#22C55E' }}>Robinhood Chain Projects</span>
        </h1>
        <p className="text-gray-500 text-sm max-w-md mx-auto">
          Discover the best projects building on Robinhood Chain — from DeFi to tokenized assets to infrastructure.
        </p>
      </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {rest.map((project: any) => (
                ...
                >
                  <div className="w-9 h-9 rounded-lg flex items-center justify-center text-base flex-shrink-0 overflow-hidden" style={{ backgroundColor: 'rgba(34,197,94,0.1)' }}>
                    {project.logo ? (
                      <img
                        src={project.logo}
                        alt={project.name}
